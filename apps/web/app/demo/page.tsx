...
export default async function DemoPage({ searchParams }: { searchParams: Promise<{ view?: string }> }) {
  ...
  return <RelayApp initialBrands={demoBrands} initialAccounts={demoAccounts} initialPosts={demoPosts} initialPublishingDefaults={defaultPublishingDefaults} initialNow="2026-08-23T11:00:00.000Z" initialView={query.view ? parseRelayView(query.view) : "analytics"} user={{ name: "Mara Silva", email: "mara@example.com", role: "OWNER" }} />;
}
