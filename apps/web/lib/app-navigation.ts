export const relayViews = ["home", "calendar", "posts", "analytics", "slideshows", "videos", "media", "brands", "accounts", "settings"] as const;
...
export const viewLabel: Record<RelayView, string> = {
  ...
  media: "Media", brands: "Brands", accounts: "Accounts", settings: "Settings",
};
